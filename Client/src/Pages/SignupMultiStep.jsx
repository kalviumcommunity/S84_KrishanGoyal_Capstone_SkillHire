...
const handleStep2Submit = async (e) => {
  ...
  try {
    ...
    const res = await axios.post(`${baseUrl}/api/auth/complete-profile`, payload, {
      withCredentials: true
    });
...
return ( <GoogleOAuthProvider clientId={googleClientId}> <div className="signup-bg-art"> <div className="circle circle1"></div> <div className="circle circle2"></div> <div className="circle circle3"></div>
